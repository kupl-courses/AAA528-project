...
module Expr = struct
  ...
  = fun e1 e2 -> begin
    (* create_mod function start *)
    Z3.Arithmetic.Integer.mk_mod (Ctx.read ()) e1 e2
    (* create_mod function end *)
  end
...
module Solver = struct
  ...
  let get_version () = Z3.Version.full_version
